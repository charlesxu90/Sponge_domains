...
=head1 Name
    ...
    1.pick_dom_seq.pl --> This is to pick domain sequences form fasta sequences db using hmm.

=head1 Usage

    perl  1.pick_dom_seq.pl [options] [input file]
...
=head1 Example
    ...
    perl  1.pick_dom_seq.pl -h
    perl  1.pick_dom_seq.pl -hmm Ndr.hmm -fa Homo_sapiens.all.fa -d ./ -tag _dseq.fa
...
$Tag ||= '_dseq.fa';
$E   ||= '1e-5';
my $Outfile1 = basename($Fa_DB)."_id.txt";
my $Outfile2 = basename($Fa_DB).$Tag;
#============================================================================#
#                               Main process                                 #
#============================================================================#
